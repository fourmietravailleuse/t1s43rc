...
<!-- title="Icons and Icon Types" order="2" -->
...
<!-- title="Source and Status" order="2" -->
...
<!-- title="Available Actions" order="4" -->
...
<!-- template="mla-search" -->
<!-- title="Searching Known Types" order="6" -->
...
<!-- title="Disable/Enable Uploads" order="7" -->
